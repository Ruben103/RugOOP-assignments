...
public abstract class AvaibleMaterial {
	...
	public AvaibleMaterial(String author, String title, Library lib){
		this.setAuthor(author);
		this.setTitle(title);
		this.setLib(lib);
		this.setPrivateId(AvaibleMaterial.getId());
		AvaibleMaterial.setId(AvaibleMaterial.getId()+1);
	}
